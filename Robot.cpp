...
bool Robot::autonomousFinished = false;
...
void Robot::RobotInit() {
	...
	autoChooser->AddObject("Shoot Autonomous", new ShootAutonomousCommand());
	autoChooser->AddObject("Left Autonomous", new FarAutonomousCommand());
	autoChooser->AddDefault("Right Autonomous", new AutonomousCommand());
