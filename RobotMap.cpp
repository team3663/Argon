...
void RobotMap::init() {
	...
	driveTrainSpeedControlLeft1 = new Victor(1, 4);
	lw->AddActuator("DriveTrain", "SpeedControlLeft1", (Victor*) driveTrainSpeedControlLeft1);
	
	driveTrainSpeedControlLeft2 = new Victor(1, 3);
	lw->AddActuator("DriveTrain", "SpeedControlLeft2", (Victor*) driveTrainSpeedControlLeft2);
	
	driveTrainSpeedControlRight1 = new Victor(1, 1);
	lw->AddActuator("DriveTrain", "SpeedControlRight1", (Victor*) driveTrainSpeedControlRight1);
	
	driveTrainSpeedControlRight2 = new Victor(1, 5);
	lw->AddActuator("DriveTrain", "SpeedControlRight2", (Victor*) driveTrainSpeedControlRight2);
	
	driveTrainRobotDrive3663 = new RobotDrive(driveTrainSpeedControlLeft1, driveTrainSpeedControlLeft2,
              driveTrainSpeedControlRight1, driveTrainSpeedControlRight2);
    ...
    driveTrainLeftEncoder = new Encoder(1, 1, 1, 3, false, Encoder::k4X);
	...
	driveTrainRightEncoder = new Encoder(1, 2, 1, 4, true, Encoder::k4X);
	...
	shooterShooterMotorControl = new Victor(1, 2);
	...
	diskManagementShootSolenoid1 = new Solenoid(1, 7);
	lw->AddActuator("DiskManagement", "ShootSolenoid1", diskManagementShootSolenoid1);
	
	diskManagementShootSolenoid2 = new Solenoid(1, 8);
	...
	pitchLimitSwitchMax = new DigitalInput(1, 6);
	lw->AddSensor("Pitch", "LimitSwitchMax ", pitchLimitSwitchMax);
	
	pitchLimitSwitchMin = new DigitalInput(1, 7);
	...
	rangeFinderBackUltrasonicSensor = new AnalogChannel(1, 2);
	lw->AddSensor("RangeFinder", "BackUltrasonicSensor", rangeFinderBackUltrasonicSensor);
	
	rangeFinderLeftUltrasonicSensor = new AnalogChannel(1, 3);
	lw->AddSensor("RangeFinder", "LeftUltrasonicSensor", rangeFinderLeftUltrasonicSensor);
	
	rangeFinderRightUltrasonicSensor = new AnalogChannel(1, 4);
