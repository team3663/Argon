...
DriveTrain::DriveTrain() : Subsystem("DriveTrain") {
	...
	//speedControlLeft1->SetSafetyEnabled(false);
	highGear = true;
...
void DriveTrain::Arcade()
{
	...
	/*
	speedControlLeft1->Set(Robot::oi->getDriveJoystick()->GetY());
	speedControlLeft2->Set(Robot::oi->getDriveJoystick()->GetY());
	speedControlRight1->Set(-Robot::oi->getDriveJoystick()->GetY());
	speedControlRight2->Set(-Robot::oi->getDriveJoystick()->GetY());
	*/
